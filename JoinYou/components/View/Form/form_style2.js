...
export default class FormStyle2 extends Component<Props> {
              ...
              return {
                  headerTitle: (
                      <View style={{flex:1, flexDirection:'row', justifyContent:'center',alignItems:'center'}}>
                            <Text style={{fontSize:17,color:GlobalInclude.Color.HeaderTextColor,fontFamily:GlobalInclude.Font.FontBold}}>Form Style 2</Text>
                      </View>
                  ),
